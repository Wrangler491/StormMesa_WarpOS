/* $Id: tessdemo.c,v 3.3 1998/07/26 01:25:26 brianp Exp $ */
...
void CALLBACK my_error(GLenum err)
{
	int len,i;
#ifndef __STORM__
	char const *str;
...
void CALLBACK edge_callback(GLenum flag)
{
	if(flag==GL_TRUE)
	{
...
void CALLBACK vertex_callback(void *data)
{
	GLsizei no;
	GLint *p;
...
void CALLBACK my_glBegin(GLenum a)
{
	glBegin(a);
}

void CALLBACK my_glEnd()
{
	glEnd();
}

void CALLBACK my_glVertex2iv(void* a)
{
	glVertex2iv(a);
}
...
void tesse(void)
{
	...
	if(tobj!=NULL)
	{
		...
		gluTessCallback(tobj,GLU_END,(void(CALLBACK *)())my_glEnd);
		gluTessCallback(tobj,GLU_ERROR,(void(CALLBACK *)())my_error);
		gluTessCallback(tobj,GLU_VERTEX,(void(CALLBACK *)())my_glVertex2iv);
#else
#ifndef __STORM__
...
#else
		gluTessCallback(tobj,GLU_BEGIN,(void(CALLBACK *)())begin_callback);
		gluTessCallback(tobj,GLU_END,(void(CALLBACK *)())end_callback);
		gluTessCallback(tobj,GLU_VERTEX,(void(CALLBACK *)())vertex_callback);
		gluTessCallback(tobj,GLU_EDGE_FLAG,(void(CALLBACK *)())edge_callback);
#endif
		gluBeginPolygon(tobj);
		for(j=0;j<=contour_cnt;j++)
		{
