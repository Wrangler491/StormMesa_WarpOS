      ...
      switch (ctx->Array.ColorType) {
         case GL_BYTE:
            switch (ctx->Array.ColorSize) {
               case 4:   aglColor4bv(ctx, (GLbyte*) p );   break;
               case 3:   aglColor3bv(ctx, (GLbyte*) p );   break;
            }
            break;
         case GL_UNSIGNED_BYTE:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3ubv(ctx,(GLubyte*) p );   break;
               case 4:   aglColor4ubv(ctx,(GLubyte*) p );   break;
            }
            break;
         case GL_SHORT:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3sv(ctx,(GLshort*) p );   break;
               case 4:   aglColor4sv(ctx,(GLshort*) p );   break;
            }
            break;
         case GL_UNSIGNED_SHORT:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3usv(ctx,(GLushort*) p );   break;
               case 4:   aglColor4usv(ctx,(GLushort*) p );   break;
            }
            break;
         case GL_INT:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3iv(ctx,(GLint*) p );   break;
               case 4:   aglColor4iv(ctx,(GLint*) p );   break;
            }
            break;
         case GL_UNSIGNED_INT:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3uiv(ctx,(GLuint*) p );   break;
               case 4:   aglColor4uiv(ctx,(GLuint*) p );   break;
            }
            break;
         case GL_FLOAT:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3fv(ctx,(GLfloat*) p );   break;
               case 4:   aglColor4fv(ctx,(GLfloat*) p );   break;
            }
            break;
         case GL_DOUBLE:
            switch (ctx->Array.ColorSize) {
               case 3:   aglColor3dv(ctx,(GLdouble*) p );   break;
               case 4:   aglColor4dv(ctx,(GLdouble*) p );   break;
            }
            break;
         default:
...
void gl_save_ArrayElement( GLcontext *ctx, GLint i )
{
   ...
   if (ctx->Array.NormalEnabled) {
      ...
      switch (ctx->Array.NormalType) {
         case GL_BYTE:
            aglNormal3bv(ctx,(GLbyte*) p );
            break;
         case GL_SHORT:
            aglNormal3sv(ctx,(GLshort*) p );
            break;
         case GL_INT:
            aglNormal3iv(ctx,(GLint*) p );
            break;
         case GL_FLOAT:
            aglNormal3fv(ctx,(GLfloat*) p );
            break;
         case GL_DOUBLE:
            aglNormal3dv(ctx,(GLdouble*) p );
            break;
         default:
   ...
   if (ctx->Array.IndexEnabled) {
      ...
      switch (ctx->Array.IndexType) {
         case GL_SHORT:
            aglIndexsv(ctx,(GLshort*) p );
            break;
         case GL_INT:
            aglIndexiv(ctx,(GLint*) p );
            break;
         case GL_FLOAT:
            aglIndexfv(ctx,(GLfloat*) p );
            break;
         case GL_DOUBLE:
            aglIndexdv(ctx,(GLdouble*) p );
            break;
         default:
   ...
   for (texSet=0; texSet<MAX_TEX_SETS; texSet++) {
      if (ctx->Array.TexCoordEnabled[texSet]) {
         ...
         switch (ctx->Array.TexCoordType[texSet]) {
            case GL_SHORT:
               switch (ctx->Array.TexCoordSize[texSet]) {
                  case 1:   aglMultiTexCoord1svSGIS(ctx,target, (GLshort*) p );   break;
                  case 2:   aglMultiTexCoord2svSGIS(ctx,target, (GLshort*) p );   break;
                  case 3:   aglMultiTexCoord3svSGIS(ctx,target, (GLshort*) p );   break;
                  case 4:   aglMultiTexCoord4svSGIS(ctx,target, (GLshort*) p );   break;
               }
               break;
            case GL_INT:
               switch (ctx->Array.TexCoordSize[texSet]) {
                  case 1:   aglMultiTexCoord1ivSGIS(ctx,target, (GLint*) p );   break;
                  case 2:   aglMultiTexCoord2ivSGIS(ctx,target, (GLint*) p );   break;
                  case 3:   aglMultiTexCoord3ivSGIS(ctx,target, (GLint*) p );   break;
                  case 4:   aglMultiTexCoord4ivSGIS(ctx,target, (GLint*) p );   break;
               }
               break;
            case GL_FLOAT:
               switch (ctx->Array.TexCoordSize[texSet]) {
                  case 1:   aglMultiTexCoord1fvSGIS(ctx,target, (GLfloat*) p );   break;
                  case 2:   aglMultiTexCoord2fvSGIS(ctx,target, (GLfloat*) p );   break;
                  case 3:   aglMultiTexCoord3fvSGIS(ctx,target, (GLfloat*) p );   break;
                  case 4:   aglMultiTexCoord4fvSGIS(ctx,target, (GLfloat*) p );   break;
               }
               break;
            case GL_DOUBLE:
               switch (ctx->Array.TexCoordSize[texSet]) {
                  case 1:   aglMultiTexCoord1dvSGIS(ctx,target, (GLdouble*) p );   break;
                  case 2:   aglMultiTexCoord2dvSGIS(ctx,target, (GLdouble*) p );   break;
                  case 3:   aglMultiTexCoord3dvSGIS(ctx,target, (GLdouble*) p );   break;
                  case 4:   aglMultiTexCoord4dvSGIS(ctx,target, (GLdouble*) p );   break;
               }
               break;
            default:
   ...
   if (ctx->Array.VertexEnabled) {
      ...
      switch (ctx->Array.VertexType) {
         case GL_SHORT:
            switch (ctx->Array.VertexSize) {
               case 2:   aglVertex2sv(ctx,(GLshort*) b );   break;
               case 3:   aglVertex3sv(ctx,(GLshort*) b );   break;
               case 4:   aglVertex4sv(ctx,(GLshort*) b );   break;
            }
            break;
         case GL_INT:
            switch (ctx->Array.VertexSize) {
               case 2:   aglVertex2iv(ctx,(GLint*) b );   break;
               case 3:   aglVertex3iv(ctx,(GLint*) b );   break;
               case 4:   aglVertex4iv(ctx,(GLint*) b );   break;
            }
            break;
         case GL_FLOAT:
            switch (ctx->Array.VertexSize) {
               case 2:   aglVertex2fv(ctx,(GLfloat*) b );   break;
               case 3:   aglVertex3fv(ctx,(GLfloat*) b );   break;
               case 4:   aglVertex4fv(ctx,(GLfloat*) b );   break;
            }
            break;
         case GL_DOUBLE:
            switch (ctx->Array.VertexSize) {
               case 2:   aglVertex2dv(ctx,(GLdouble*) b );   break;
               case 3:   aglVertex3dv(ctx,(GLdouble*) b );   break;
               case 4:   aglVertex4dv(ctx,(GLdouble*) b );   break;
            }
            break;
         default:
