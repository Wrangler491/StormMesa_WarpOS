...
#ifdef DRIVEREXT
typedef void (*linestrip_func)( GLcontext *ctx,
                               GLuint first, GLuint last );
typedef void (*tristrip_func)( GLcontext *ctx,
                               GLuint first, GLuint last );
typedef void (*trifan_func)( GLcontext *ctx,
                             GLuint zero, GLuint first, GLuint last );
#endif
...
#define FRONT_MATERIAL_BITS (FRONT_EMISSION_BIT | FRONT_AMBIENT_BIT | FRONT_DIFFUSE_BIT | FRONT_SPECULAR_BIT | FRONT_SHININESS_BIT | FRONT_INDEXES_BIT)
#define BACK_MATERIAL_BITS  (BACK_EMISSION_BIT | BACK_AMBIENT_BIT | BACK_DIFFUSE_BIT | BACK_SPECULAR_BIT | BACK_SHININESS_BIT | BACK_INDEXES_BIT)
