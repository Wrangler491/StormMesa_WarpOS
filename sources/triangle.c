...
#define INNER_LOOP( LEFT, RIGHT, Y )                            \
        {                                                       \
           ...
           if (n>0) {                                           \
              ...
              gl_write_texture_span( ctx, n, LEFT, Y, (const GLdepth*)zspan,    \
 (const GLfloat*)s, (const GLfloat*)t, (const GLfloat*)u, NULL,             \
...
#define INNER_LOOP( LEFT, RIGHT, Y )                            \
        {                                                       \
           ...
           if (n>0) {                                           \
              ...
              gl_write_texture_span( ctx, n, LEFT, Y, (const GLdepth*)zspan,    \
 (const GLfloat*)s, (const GLfloat*)t, (const GLfloat*)u, NULL,             \
                                     rgba, (CONST GLubyte(*)[4])spec, GL_POLYGON );  \
           }                                                    \
        }
...
#define INNER_LOOP( LEFT, RIGHT, Y )                                    \
        {                                                               \
           ...
           if (n>0) {                                                   \
              ...
              gl_write_texture_span( ctx, n, LEFT, Y, (const GLdepth*)zspan,            \
 (const GLfloat*)s, (const GLfloat*)t, (const GLfloat*)u, lambda,                   \
                                     rgba, NULL, GL_POLYGON );          \
           }                                                            \
        }
...
#define INNER_LOOP( LEFT, RIGHT, Y )                                    \
        {                                                               \
           ...
           if (n>0) {                                                   \
              ...
              gl_write_multitexture_span( ctx, 2, n, LEFT, Y, (const GLdepth*)zspan,    \
         (CONST GLfloat(*)[MAX_WIDTH])s, (CONST GLfloat(*)[MAX_WIDTH])t, (CONST GLfloat(*)[MAX_WIDTH])u, lambda,              \
                                          rgba, NULL, GL_POLYGON );     \
           }                                                            \
        }
