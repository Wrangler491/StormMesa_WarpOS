...
#ifdef WARPUP
APIENTRY struct amigamesa_visual *AmigaMesaCreateVisual(struct TagItem *tagList);
APIENTRY struct amigamesa_context *AmigaMesaCreateContext(struct TagItem *tagList);
APIENTRY void AmigaMesaDestroyVisual(struct amigamesa_visual *v);
APIENTRY void AmigaMesaDestroyContext(struct amigamesa_context *c);
APIENTRY void AmigaMesaMakeCurrent(struct amigamesa_context *c, struct amigamesa_buffer *b);
APIENTRY void AmigaMesaSwapBuffers(struct amigamesa_context *amesa);
APIENTRY void AmigaMesaSetOneColor(struct amigamesa_context *c, int index, float r, float g, float b);
APIENTRY void AmigaMesaSetRast(struct amigamesa_context *c, struct TagItem *tagList);
APIENTRY void AmigaMesaGetConfig(struct amigamesa_visual *v, GLenum pname, GLint* params);
#else
