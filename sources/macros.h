...
#if defined(AMIGA) && (!( (defined(NOASM_68K) || defined(NOASM_PPC))) )
extern void q_memcpy( void* dst, void* src, size_t bytes );
extern void q_memset( void* dst, int val, size_t n );
#endif
...
#elif defined(AMIGA) && (!( (defined(NOASM_68K) || defined(NOASM_PPC)) ))
#define MEMCPY( DST, SRC, BYTES) \
        q_memcpy( (void *) (DST), (void *) (SRC), (size_t) (BYTES) )
#else
#define MEMCPY( DST, SRC, BYTES) \
...
#elif defined(AMIGA) && (!( (defined(NOASM_68K) || defined(NOASM_PPC))) )
#define MEMSET( DST, VAL, N ) \
        q_memset( (void *) (DST), (int) (VAL), (size_t) (N) );
#else
#define MEMSET( DST, VAL, N ) \
