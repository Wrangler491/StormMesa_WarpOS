...
static void execute_list( GLcontext *ctx, GLuint list )
{
   ...
   while (!done) {
     ...
     case OPCODE_CLIP_PLANE:
        {
           ...
           g_params[2] = n[4].f;
           g_params[3] = n[5].f;
           gl_ClipPlane( ctx, n[1].e, g_params );
#else
           GLfloat equ[4];
           equ[0] = n[2].f;
           equ[1] = n[3].f;
     ...
     case OPCODE_LIGHT:
        {
           ...
           g_params[2] = n[4].f;
           g_params[3] = n[5].f;
           gl_Lightfv( ctx, n[1].e, n[2].e, g_params, 4 );
#else
           GLfloat p[4];
           p[0] = n[3].f;
           p[1] = n[4].f;
     ...
     case OPCODE_LIGHT_MODEL:
        {
           ...
           g_params[2] = n[4].f;
           g_params[3] = n[5].f;
           gl_LightModelfv( ctx, n[1].e, g_params );
#else
           GLfloat p[4];
           p[0] = n[2].f;
           p[1] = n[3].f;
     ...
     case OPCODE_MATERIAL:
        {
           ...
           g_params[2] = n[5].f;
           g_params[3] = n[6].f;
           gl_Materialfv( ctx, n[1].e, n[2].e, g_params );
#else
           GLfloat params[4];
           params[0] = n[3].f;
           params[1] = n[4].f;
     ...
     case OPCODE_POINT_PARAMETERS:
        ...
        g_params[1] = n[3].f;
        g_params[2] = n[4].f;
        gl_PointParameterfvEXT( ctx, n[1].e, g_params );
#else
        GLfloat params[3];
        params[0] = n[2].f;
        params[1] = n[3].f;
     ...
     case OPCODE_TEXENV:
        {
           ...
           g_params[2] = n[5].f;
           g_params[3] = n[6].f;
           gl_TexEnvfv( ctx, n[1].e, n[2].e, g_params );
#else
           GLfloat params[4];
           params[0] = n[3].f;
           params[1] = n[4].f;
     ...
     case OPCODE_TEXGEN:
        {
           ...
           g_params[2] = n[5].f;
           g_params[3] = n[6].f;
           gl_TexGenfv( ctx, n[1].e, n[2].e, g_params );
#else
           GLfloat params[4];
           params[0] = n[3].f;
           params[1] = n[4].f;
     ...
     case OPCODE_TEXPARAMETER:
        {
           ...
           g_params[2] = n[5].f;
           g_params[3] = n[6].f;
           gl_TexParameterfv( ctx, n[1].e, n[2].e, g_params );
#else
           GLfloat params[4];
           params[0] = n[3].f;
           params[1] = n[4].f;
     ...
     default:
        {
           char msg[1000];
           LibsPrintf(msg, "Error in execute_list: opcode=%d", (int) opcode);
           gl_problem( ctx, msg );
        }
        done = GL_TRUE;
      }
